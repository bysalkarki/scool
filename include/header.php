            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="top-contact list-text-white d-table">
                        <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+977 056 591422</a></li>
                        <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>hembahadur@realestatest.com</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <?php
                            // This condition checks if the session variable 'utype' is set and is either 'admin', 'agent', or 'builder'
                            if (isset($_SESSION['utype']) && in_array($_SESSION['utype'], ['admin', 'agent', 'builder'])) { ?>
