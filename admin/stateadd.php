...
include '../include/Algorithm/quickSortAlgo.php';
						...
						<div class="card-body">
							...
							<table id="basic-datatable " class="table table-bordered table-hover">
								...
								<tbody>
									...
									$results = quickSortAlgo($query, 'sname');
									...
									?>
											<tr>
												...
												<td><a href="stateedit.php?id=<?php echo $row['sid']; ?>"><button class="btn btn-info">Edit</button></a>
